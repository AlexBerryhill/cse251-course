...
Describe how to speed up part 1
 ...
 Instead of waiting for each request to finish before moving on, 
 I've started multiple requests at once using threads. This lets 
 them run together, which can speed things up. I first get the 
 family data in a separate thread, then create a family object and 
 add it to the tree.

Describe how to speed up part 2

I've made the breadth_fs_pedigree function faster by using a queue 
and threading. It works like this: I put the initial family ID in 
the queue, then use threads to request and process family, husband, 
wife, and child data concurrently, making the whole process quicker 
and more efficient.


Extra (Optional) 10% Bonus to speed up part 3

I make things faster by using a thread pool executor. I put the 
initial family ID in a queue and process family, husband, wife, and 
child data concurrently within the thread limit. This way, you can 
handle multiple requests at once, speeding up the process and getting 
